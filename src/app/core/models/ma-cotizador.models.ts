...
/** Respuesta de GET /api/MA/marcas */
...
/** Respuesta de GET /api/MA/modelos?marca=X */
...
/** Respuesta de GET /api/MA/versiones?marca=X&modelo=Y */
export type VehicleVersionsResponse =
  | VehicleVersion[]
  | {
